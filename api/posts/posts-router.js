...
//Creates a post 
//using the information sent inside the request body 
//and returns the newly created post object
router.post('/', (req, res) => {
...
//and returns the deleted post object
...
//and returns the modified document, not the original
